...
type AddressProps = {
  ...
  editPrefecture?: string | undefined;
  city: string;
...
const AddressInput = (props: AddressProps) => {
  ...
  return (
    <div>
      ...
      <div>
        {editBilding?(        <><label htmlFor="building"></label><TextField
          type="text"
          id="building"
          label="番地（建物名）"
          fullWidth
          value={editBilding}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setBuilding(e.target.value)} /></>):(        <><label htmlFor="building"></label><TextField
            type="text"
            id="building"
            label="番地（建物名）"
            fullWidth
